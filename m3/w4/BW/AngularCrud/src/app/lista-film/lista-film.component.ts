...
export class ListaFilmComponent implements OnInit {
  ...
  displayedColumns: string[] = ['id', 'filmName', 'category', 'description', 'action'];
  ...
  getAllFilms(){
    ...
    error:()=>{
      alert("Errore durante il fetch dei records!")
    }
  ...
  deleteFilm(id:number){
    ...
    .subscribe({
      ...
      error:(err)=>{
        alert("Errore durante la cancellazione del film")
      }
    })
  }  
